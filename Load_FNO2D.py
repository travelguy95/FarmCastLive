...
class FNO2d(nn.Module):
    def __init__(self, modes1, modes2, width):
        ...
        self.fc0 = nn.Linear(54, self.width)

        # input channel is 54: the solution of the previous 52 timesteps + 2 locations (u(t-10, x, y), ..., u(t-1, x, y),  x, y)
        ...
        self.fc1 = nn.Linear(self.width, 128) #128
